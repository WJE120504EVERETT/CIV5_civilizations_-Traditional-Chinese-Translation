...
VALUES	('CIVILIZATION_EW_RUSSIA',	'Cordiform',	47,	33,		null,	null,	null),
		('CIVILIZATION_EW_RUSSIA',	'EarthMk3',	57,	73,	null,	null,	null),
		('CIVILIZATION_EW_RUSSIA',	'GreatestEarth',	74,	55,	null,	null,	null),
		('CIVILIZATION_EW_RUSSIA',	'RussiaLarge',	40,	5,	null,	null,	null),
		('CIVILIZATION_EW_RUSSIA',	'Yagem', 57,	71,	null,	null,	null),
		('CIVILIZATION_EW_RUSSIA',	'Yahem',	88,	62,	null,	null,	null);
...
SELECT	'CIVILIZATION_EW_RUSSIA', MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
VALUES	('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_DECOLONIZATION',		 8),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_MERCENARY',				 8),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 8),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 8), --Scale of Liberal to Authoritarian.
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_LEGAL',			 3), 	
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_CULTURE',		 3),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_ECONOMIC',		 6),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 5),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_FOREIGN',		 7),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_INDUSTRY',		 7),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_MILITARY',		 8),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_REFORM_RELIGION',		 5),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_SLAVERY',				 7),
		('LEADER_EW_FRONTENAC',	'FLAVOR_JFD_STATE_RELIGION',		 3);
...
SELECT	'CIVILIZATION_EW_RUSSIA',	ArtDefineTag, CultureType, SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
FROM Civilization_JFD_CultureTypes WHERE CivilizationType = 'CIVILIZATION_RUSSIA';

UPDATE Civilizations 
SET SoundtrackTag = 'JFD_Polar'
WHERE Type = 'CIVILIZATION_EW_RUSSIA'
